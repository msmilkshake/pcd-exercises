...
import pt.hmsk.week6.ex2.tiago.BlockingQueue;
...
public class ThreadPoolTiago {
    private final int numWorkers;
    private final pt.hmsk.week6.ex2.tiago.BlockingQueue<Runnable> taskQueue;
    private final List<Worker> workers;
    private final AtomicBoolean isShutdownInitiated;

    public ThreadPoolTiago(int numWorkers, int queueCapacity) {
   ...
   //         while (!isShutdownInitiated.get() || !taskQueue.isEmpty()) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ThreadPoolTiago threadPool = new ThreadPoolTiago(5, 10);
